            ...
            <div className='col-span-12 lg:col-span-5 xl:col-span-4 pt-3 md:pt-8 mt-3 md:mt-8 lg:pt-0 lg:mt-0 border-t border-t-gray-300 lg:border-0 flex flex-col justify-between items-center lg:items-start gap-5 lg:pl-8'>
                ...
                <div>
                    ...
                    <div className="relative flex items-end gap-x-2 p-2">
                        ...
                        <div className="relative" onClick={()=>handleButtonClick('https://www.instagram.com/anushastructures/')}>
                            <div
                                // style={{clipPath: url(#squircleClip)}}
                        ...
                        <div className="relative"  onClick={()=>handleButtonClick('https://www.facebook.com/profile.php?id=61586192982422')}>
                            <div
                                // style={{clipPath: url(#squircleClip)}}
                                className="w-14 h-14 bg-[#1877F2] rounded-xl flex items-center justify-center shadow-lg cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
                            >
                                <svg fill="#fff " viewBox="0 0 24 24" className='h-10 w-10 text-white'>
