    ...
    <section id='ourJourney' className=' h-full w-full'>
      <div className='sm:container mx-auto pb-0 md:pb-10 py-10 px-4 lg:py-20 flex flex-col xl:flex-row gap-6 md:gap-14 xl:gap-20'>
        ...
        <div className='xl:w-1/3 flex flex-col gap-5 xl:gap-20'>
          ...
          <div id='ourJour' className='bg-[url("https://res.cloudinary.com/djw3rcz4j/image/upload/v1771930956/um78aqawgkkbyqakxks2_bnfxy5.webp")]
           h-[500px] p-8 shadow-sm rounded-3xl flex bg-cover bg-center bg-no-repeat'>
        ...
        <div className='h-full xl:w-2/3 flex flex-col gap-5 justify-between'>
          <Heading align='left' text={"Turning vision Into Timeless Landmarks"} />

          <div className='flex flex-col md:flex-row gap-5 lg:gap-10 2xl:pt-10'>

           <img src={"https://res.cloudinary.com/djw3rcz4j/image/upload/v1771932527/our-journey-2_aqbsui.webp"} loading='lazy' alt="anusha constructions interior" title='interior design of anusha structures'
