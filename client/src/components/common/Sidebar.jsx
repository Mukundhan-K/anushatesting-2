...
const Sidebar = ({openNavDrawer, setOpenNavDrawer, navLinkContent}) => {
  ...
  return (<>
     <div className={`w-full fixed inset-0 z-[15] bg-black/50 backdrop-blur-sm overflow-y-auto p-4
            ${openNavDrawer ? "block" : "hidden"}
    `}>

        <div id='sidebar' ref={ref} className={`fixed top-0 left-0 h-full w-3/4 sm:w-1/2 md:w-2/5 lg:w-1/4 bg-white shadow-lg transform
                    ...
                    <div className='w-full flex justify-center'>
                        ...
                        <div className="relative flex items-end gap-x-2 p-2">
                            ...
                            <div className="relative"  onClick={()=>handleButtonClick('https://www.facebook.com/profile.php?id=61586192982422')}>
                                <div
                                    // style={{clipPath: url(#squircleClip)}}
                                    className="w-10 h-10 bg-[#1877F2] rounded-xl flex items-center justify-center shadow-lg cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
                                >
                                    <svg fill="#fff " viewBox="0 0 24 24" className='h-8 w-8 text-white'>
